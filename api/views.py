...
def showMap(request):
    return render(request, 'dashboardSeller/map.html')

def showCalendar(request):
    return render(request, 'dashboardSeller/cc.html')
...
def deleteProduct(request, pk):
	...
	return render(request, 'dashboardSeller/deleteProduct.html', context)
